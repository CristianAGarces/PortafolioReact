...
const listProject = [
  ...
  },
  {
    ...
    name: "Fundapmacoe",
    description:
      "Este proyecto de la Fundación fundapmacoe, sin animos de lucro. Trabaja en la implementacion de un sistema para la gestion de madres cabeza de hogar de todo tipos de etnia blanca, india o mestiza que quieran nuevas alternativas de vida para tener trabajos dignos de calidad o tener espacios sociales para compartir con otras madres cabezas de hogar o simplemente brindarles ayuda juridica si tienen problemas intrafamiliares.",
    img: Artiefy,
  ...
  },
  {
    ...
    name: "Artiefy Inc.",
    description:
      "Plataforma de LMS digital buscando mejorar el acceso a la educación a todas las personas sin restricciones de edad, estrato social, etnia o país. Aqui mi funcion fue desarrollar logica de frontend, backend y colaborar en el modelado de base de datos para la plataforma. Ademas de colaborar en el diseño de la interfaz y experiencia de usuario.",
    img: Artiefy,
